...
public class CountyDefinition extends MultiStatisticsAbstract 
{
    ...
    /** List of component stations: we will just use keys 0, 1, ... */
     ...
     * 0. The name of the county 
     * 1/2: long/lat of first point in the polygon. 
     * 3/4: long/lat of the 2nd point, 
    ...
    public CountyDefinition(String[] elements)
    {
        ...
        {
            int x = (int)((Double.parseDouble(
                    elements[i]) * StateFrame.LONGITUDE_SCALE));
            int y = (int)((Double.parseDouble(
                    elements[i + 1]) * StateFrame.LATITUDE_SCALE));
    ...
    protected void draw(Graphics2D g2)
    {
        ...
        // Draw stations
        for (Map.Entry<Integer, StationDefinition> entry: 
            stations.entrySet())
        {
